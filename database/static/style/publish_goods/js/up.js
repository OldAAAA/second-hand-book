...
$(function() {
    ...
    $(".file").change(function() {
        ...
        //图片总的数量可自定义
        if (fileList.length > goods_num || totalNum > goods_num) {
            alert("你好！上传图片不得超过5张，请重新选择");
            //一次选择上传超过goods_num个  自己定义
        } else if (numUp < goods_num) {
            ...
            for (var i = 0; i < fileList.length; i++) {
                ...
                $img0.attr("src", "./static/style/publish_goods/img/close.png").appendTo($section);
